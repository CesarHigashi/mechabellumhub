    ...
    <div class = "create-form">
        ...
        <div class="form-group group-coustume">
            <form action="/tank/{{$tank->id}}" method="POST">
                ...
                <input type="text" class="form-control name-form" placeholder="Año de creación" name="year" id="year" value="{{ old('year') ?? $tank->year }}">
                @error('year')
                    <i>{{ $message }}</i>
                @enderror
                <br>
                ...
                <input type="text" class="form-control name-form" placeholder="País de origen" name="country" id="country" value="{{ old('country') ?? $tank->country }}">
                @error('country')
                    <i>{{ $message }}</i>
                @enderror
                <br>
